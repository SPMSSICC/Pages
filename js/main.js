...
var uAgent = window.navigator.userAgent.toUpperCase()
  ...
  , arrDocs = []
  , reformatedArrDocs = []
  , arrDocNames = [ 'about','apresentacao_snc_ap','apresentação_20_nov_snc_ap','cer_migracao_sicc','chave_orcamental_por_ano','circ1381','circ1382','dec_lei85','dec_lei192','documentos_af_e_ar','gestao_exercicios','gestao_projetos','help','importacao_csvs','macro_tarefas','menus_draft','menus','mu_snc_ap','mu_snc_ap_draft','perguntas_frequentes','processos','reposicao_pagamentos_cobrancas','snc_ap_faqs']
  , lastSearchStr = "";
