...
</br>A lista de documentos que correspondem aos critérios de pesquisa aparece na janela respetiva.
...
</br>O utilizador deve também indicar se o mapa gerado é para a UniLeo ou para ACSS. Esta indicação deve ser realizada através da selecção da respetiva checkbox ![](https://spmssicc.github.io/pages/markdown/mu_snc_ap.assets/mu_snc_ap-9d90d070.png)
...
|CSV|XML|
|:--:|:--:|
|![](https://spmssicc.github.io/pages/markdown/mu_snc_ap.assets/mu_snc_ap-35d38649.png)  | ![](https://spmssicc.github.io/pages/markdown/mu_snc_ap.assets/mu_snc_ap-75831d9f.png) |

#### 8.2.2. AI - Ativos Intangíveis

Nesta opção o utilizador define os parêmetros de pesquisa, para gerar o ficheiro correspondente ao AI.

![](mu_snc_ap.assets/mu_snc_ap-34e8bd48.png)
...
|CSV|XML|
|:--:|:--:|
|![](https://spmssicc.github.io/pages/markdown/mu_snc_ap.assets/mu_snc_ap-35d38649.png)  | ![](mu_snc_ap.assets/mu_snc_ap-c5e0a74b.png) | -->

#### 8.2.3. BA - Balancete Analítico

Nesta opção o utilizador define os parêmetros de pesquisa, para gerar o ficheiro correspondente ao balancete analítico (BA).

![](https://spmssicc.github.io/pages/markdown/mu_snc_ap.assets/mu_snc_ap-886c4626.png)
...
![](https://spmssicc.github.io/pages/markdown/mu_snc_ap.assets/mu_snc_ap-91838210.png)
...
#### 8.2.5. CPLC - Correspondência Plano Contas
...
#### 8.2.7. DDORC - Demonstração de Desempenho Orçamental

#### 8.2.8. DFC - Demosntração dos Fluxos de Caixa

#### 8.2.9. DODES - Dem. Exec. Orçamental - Despesa

#### 8.2.10. DOREC - Dem. Exec. Orçamental - Receita

#### 8.2.11. DPPI - Dem. Exec. P.Pluri. Invest. -->

#### 8.2.12. DR - Demonstarção dos Resultados por Natureza
...
<!-- #### 8.2.13. DTAS - Dívidas a Terc. por Ant. de Saldos

#### 8.2.14. EC -Encargos Cotratuais

#### 8.2.15. Propriedades de Investimento -->
