...
var uAgent = window.navigator.userAgent.toUpperCase()
  ...
  , arrDocs = []
  , reformatedArrDocs = []
  , arrDocNames = ['about','analitica','apresentacao_abril_2019','apresentacao_snc_ap','apresentação_20_nov_snc_ap', 'apresentação_25_mai_des','atual_sist_7_dez','atual_sist_16_mar','atual_sist_2_mar', 'atual_sist_9_mar','introducao','parametrizacao','orcamento','ciclo_despesa','ciclo_receita','fundos_alheios','operacoes_diversas', 'gestao_tesouraria', 'gestao_terceiros', 'dec.lei_2213_2018', 'contab_geral', 'utilitarios','scp', 'atual_sist_25_mai', 'atual_sist_31_mai', 'ligacoes_csv_sicc', 'atual_sist_12_abr_9','atual_sist_06_dez_9','atual_sist_29_nov_9','atual_sist_08_nov_9','atual_sist_22_nov_9','atual_sist_15_nov_9','atual_sist_18_out_9','atual_sist_11_out_9','atual_sist_27_set_9','apresentacao_I_encontro_nacional_2019','atual_sist_20_set_9','atual_sist_29_ago_9','atual_sist_5_set_9','atual_sist_13_set_9','atual_sist_22_ago_9','atual_sist_09_ago_9','atual_sist_02_ago_9','atual_sist_26_jul_9','atual_sist_19_jul_9','atual_sist_12_jul_9','atual_sist_05_jul_9','atual_sist_28_jun_9','atual_sist_19_jun_9','atual_sist_07_jun_9','atual_sist_31_mai_9','atual_sist_24_mai_9','atual_sist_17_mai_9','atual_sist_10_mai_9','atual_sist_03_mai_9','atual_sist_18_abr_9','atual_sist_5_abr_9','atual_sist_29_mar_9','atual_sist_22_mar_9','apuramento_resultados','apresentação_janeiro_2019','atual_sist_15_mar_9','atual_sist_1_mar_9','atual_sist_22_fev_9','atual_sist_15_fev_9','atual_sist_8_fev_9','atual_sist_1_fev_9','atual_sist_25_jan_9','atual_sist_17_jan_9','atual_sist_11_jan_9','atual_sist_26_dez','atual_sist_30_nov','atual_sist_31_out','atual_sist_26_out','atual_sist_19_out','atual_sist_28_set','atualizacoes','atual_sist_20_set','atual_sist_14_sep','atual_sist_6_sep','atual_sist_16_ago','atual_sist_20_jul','atual_sist_6_jul','atual_sist_29_jun','atual_sist_7_jun','atual_sist_18_mai','atual_sist_11_mai','atual_sist_4_mai','atual_sist_27_abr','atual_sist_20_abr','atual_sist_13_abr','atual_sist_6_abr','gestao_perfis','atual_sist_29_mar','atual_sist_23_mar','atual_sist_23_fev','atual_sist_16_fev','atual_sist_9_fev','entidades_contas_2018','atual_sist_8_fev','atual_sist_2_fev','atual_sist_12_jan','atual_sist_19_jan','atual_sist_26_jan','check_list','cer_migracao_sicc','chave_orcamental_por_ano','circ1381','circ1382','dec_lei85','dec_lei192','ligacoes_si','documentos_af_e_ar','gestao_exercicios','gestao_projetos','help','check_list_mig','importacao_csvs','macro_tarefas','menus_draft','menus','perguntas_frequentes','processos','redmine','reposicao_pagamentos_cobrancas','snc_ap_faqs','vencimentos']
  , lastSearchStr = "";
...
function loadIntroducao(btnsToShow, event) {

	startLoader();

	$("#fileHistory, #behindFileHistory").remove();

	var filePath ='./html/introducao.html';
  ...
  $('footer').addClass('documentMode');
	...
	.done(function(data){
			...
			setTimeout(function(){stopLoader("[loadIntroducao_1]");},800);
			$("#docOptions").removeClass("active");
      $("#btnMenu").removeClass("active");
      $("#accordion").removeClass("show");
	})
	.fail(function(){
			// console.log("[loadIndexContent] Error on loading requested file: " + filePath);
			stopLoader("[loadIntroducao_2]");
	})
	.always(function(){
			window.scrollTo(0,0);
			$('#docOptions').removeClass('active');
			var stateObj = { foo: 'bar' };
			history.replaceState(stateObj, "SICC Documentação - manual de utilizador", location.href.split("?")[0]);
	});
}
...
function loadMdDoc(mdFile, btnsToShow, anchor, event) {
	...
	if( mdFile != null && mdFile != undefined ){
  	...
  	$.each(arrDocs, function(i, doc){
        ...
        if (doc.name !="introducao" && doc.name != "apresentacao_I_encontro_nacional_2019 "&& doc.name != "apresentacao_abril_2019" && doc.name != "entidades_contas_2018" && doc.name !="atualizacoes" && doc.name != "check_list_mig" && doc.name != "apresentação_25_mai_des"  && doc.name != "atual_sist_19_jun_9" && doc.name != "atual_sist_28_jun_9" && doc.name != "atual_sist_07_jul_9" && doc.name != "atual_sist_08_nov_9" && doc.name != "atual_sist_15_nov_9" && doc.name != "atual_sist_22_nov_9" && doc.name != "atual_sist_29_nov_9" && doc.name != "atual_sist_06_dez_9" ){
